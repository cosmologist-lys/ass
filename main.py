...
# 【新导入】从 Pillow 库导入 Image 模块
from PIL import Image, ImageDraw, ImageFont

# ==============================================================================
# --- 配置区 ---
# ==============================================================================
TARGET_WINDOW_TITLE = "Nacos"
...
def add_watermark(image):
    ...
    # 在画布上绘制半透明的文字
    text_color = (255, 255, 255, WATERMARK_OPACITY) # 白色，但透明度由配置决定
    ...
    return watermarked_image.convert("RGB") # 保存为JPG/PNG前转回RGB模式，避免兼容性问题
